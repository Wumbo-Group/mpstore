...
$ambil = $koneksi->query("SELECT * FROM `order` LEFT JOIN order_detail ON `order`.id_order = order_detail.id_order LEFT JOIN produk ON order_detail.id_produk = produk.id_produk WHERE produk.id_kategori = 3 AND `order`.status_pembayaran ='pending' AND `order`.bool_wa = 0");
...
CS MP Store - Sekolah Samara";
        ...
        elseif ($status_transaksi == 'settlement') {
            //kirim wa ke siswa pesan sukses Sekolah Samara
$pesan = "Assalamu'alaikum Warohmatullahi Wabarokatuh
...
CS MP Store - Sekolah Samara";
            ...
            //kirim wa ke siswa pesan gagal Sekolah Samara
$pesan = "Assalamu'alaikum Warohmatullahi Wabarokatuh
...
SALAM BERKAH MULIA
CS MP Store - Sekolah Samara";
        wa_samara($no_hp_pembeli, $pesan);
    }
    elseif ($status_transaksi == 'settlement') {
        //kirim wa ke pembeli pesan sukses Sekolah Samara
        $bool_wa = 1;
$pesan = "Assalamu'alaikum Warohmatullahi Wabarokatuh
...
CS MP Store - Sekolah Samara";
        ...
        //kirim wa ke pembeli pesan gagal Sekolah Samara
        $bool_wa = 1;
$pesan = "Assalamu'alaikum Warohmatullahi Wabarokatuh
