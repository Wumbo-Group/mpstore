...
if (isset($_GET['did'])){
	...
	if ($pencocokan == 1) {	
		...
		$dapat_jenisKategori = $dtlProduk['jenis_produk'];
	}
	else {
			...
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
						...
						<div class="item-slick3" data-thumb="images/produk/produk_barang/<?php echo $dtlProduk['foto_produk2']; ?>?nocache=<?php echo time(); ?>">
							<div class="wrap-pic-w">
								<img src="images/produk/produk_barang/<?php echo $dtlProduk['foto_produk2']; ?>?nocache=<?php echo time(); ?>" alt="IMG-PRODUCT">
							</div>
						</div>

						<div class="item-slick3" data-thumb="images/produk/produk_barang/<?php echo $dtlProduk['foto_produk3']; ?>?nocache=<?php echo time(); ?>">
							<div class="wrap-pic-w">
								<img src="images/produk/produk_barang/<?php echo $dtlProduk['foto_produk3']; ?>?nocache=<?php echo time(); ?>" alt="IMG-PRODUCT">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="flex-m flex-w p-b-10">
						...
						<div class="rs2-select2 rs3-select2 bo4 of-hidden w-size16">
							<div class="size16 bo4 m-r-10">
								<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="catatan_pb" placeholder="Contoh: Size L, Warna Hitam, dll" value="<?php echo $data_catatan; ?>">
							</div>
						</div>
					</div>
			...
			<div class="wrap-slick2">
				<div class="slick2">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						<!-- Block2 -->
						<div class="block2">
							<div class="block1 block2-img wrap-pic-w of-hidden pos-relative">
								<img src="images/produk/produk_barang/<?php echo $pSerupa['foto_produk1']; ?>?nocache=<?php echo time(); ?>" alt="IMG-PRODUCT" class="block1">
								...
								<div class="block2-overlay trans-0-4">
									...
									<div class="block2-btn-addcart w-size1 trans-0-4">
										...
										<a href="product-detail?did=<?php echo $ecLinkId ?>" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">
        									LANJUT
        								</a>
									</div>
								</div>
