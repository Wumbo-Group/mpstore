		...
		<div class="container">
				...
				<div class="wrap-table-shopping-cart bgwhite">
					<table class="table-shopping-cart">
						...
						<tr class="table-row">
							...
							<td class="column-4"><?php echo $jumlah; ?>
								<!-- <div class="flex-w bo5 of-hidden w-size17">
									<button class="btn-num-product-down color1 flex-c-m size7 bg8 eff2" name="jml_p" value="<?php echo $aPembelian['id_produk']; ?>">
										<i class="fs-12 fa fa-minus" aria-hidden="true"></i>
									</button>

									<input class="size8 m-text18 t-center num-product" type="number" name="jml_produk"  value="<?php echo $jumlah; ?>">

									<button class="btn-num-product-up color1 flex-c-m size7 bg8 eff2" name="jml_p" value="<?php echo $aPembelian['id_produk']; ?>">
										<i class="fs-12 fa fa-plus" aria-hidden="true"></i>
									</button>
								</div> -->
							</td>
							<td class="column-4"><?php echo $data_catatan; ?>
								<!-- <div class="size10 bo4 m-r-10">
									<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="catatan" placeholder="Contoh: Size L, Warna Hitam, dll" value="<?php echo $data_catatan; ?>">
								</div> -->
							</td>
			...
			<div class="bo9 w-size18 p-l-40 p-r-40 p-t-30 p-b-38 m-t-30 m-r-0 m-l-auto p-lr-15-sm">
				...
				<div class="p-t-15">
					...
					echo "<input type='hidden' name='asal' id='asal' value=".$pecah_kota['id_kota_asal'].">";
					//Get Data Kabupaten
					// $curl = curl_init();	
					...
					//Close Get Data Kabupaten
					//  echo "<option>Pilih Kota Asal</option>";
					//      $data = json_decode($response, true);
					//      for ($i=0; $i < count($data['rajaongkir']['results']); $i++) { 
					//          echo "<option value='".$data['rajaongkir']['results'][$i]['city_id']."'>".$data['rajaongkir']['results'][$i]['city_name']."-".$data['rajaongkir']['results'][$i]['city_id']."</option>";
					//      }
					//      echo "<input type='hidden' name='total_hrg' id='total_hrg' value=".$totalHarga.">";
					?>
                    ...
                    <!-- <div class="size15 trans-0-4">
						<div class="rs2-select2 rs3-select2 rs4-select2 bo4 of-hidden w-100 m-t-8 m-b-12">
							<select class="selection-2" id="kurir" name="kurir">
