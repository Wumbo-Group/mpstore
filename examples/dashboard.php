        ...
        <ul class="nav">
          <li class="active">
            <a href="dashboard.html">
              <i class="nc-icon fa fa-bank"></i>
              <p>Home</p>
            </a>
          </li>
          <li>
            <a data-toggle="collapse" href="#keuangan">
              <i class="nc-icon fa fa-money"></i>
              <p>
                Keuangan
                <b class="caret"></b>
              </p>
        ...
        <ul class="nav">
          <li>
            <a data-toggle="collapse" href="#pagesExamples">
              <i class="nc-icon fa fa-bookmark"></i>
              <p>
                Pages
                <b class="caret"></b>
              </p>
                ...
                <div class="row">
                  ...
                  <div class="col-10 col-md-10">
                    <div class="numbers">
                      ...
                      <p class="card-title">Rp. 123.456.789</p>
                    </div>
                  </div>
                </div>
              </div>
