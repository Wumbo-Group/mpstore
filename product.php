...
if (isset($_GET['ct'])) {
	...
	$ujpro = $koneksi->query("SELECT * FROM produk WHERE id_kategori = '$linkct' AND nama_produk LIKE '%".$dataPencarian."%' AND stok > 0 ORDER BY jenis_produk LIMIT $offset, $total_records_per_page");
...
if (isset($_SESSION['filt'])){
	$data_sort = $_SESSION['filt'];
	if ($data_sort == 1){
		$filtsaatini = "Standar";
	}
	elseif ($data_sort == 2){
		$filtsaatini = "Harga: Rendah ke Tinggi";
	}
	elseif ($data_sort == 3){
		$filtsaatini = "Harga: Tinggi ke Rendah";
	}

	include 'filter_produkhal.php';
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<ul class="p-b-54">
							...
							$naKat = $koneksi->query("SELECT * FROM kategori WHERE id_kategori_awal = 0");
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
						...
						<div class="flex-w">
							<div class="rs2-select2 bo4 of-hidden w-size12 m-t-5 m-b-5 m-r-10">
								<select class="selection-2" name="sorting" id="sorting">
									<option value="" disabled selected><?php echo $filtsaatini ?></option>
									...
									<!--<option value="4-<?php echo $linkct."-".$dataPencarian; ?>">Jenis: Barang</option>-->
									<!--<option value="5-<?php echo $linkct."-".$dataPencarian; ?>">Jenis: Jasa</option>-->
								</select>
							</div>
							...
							<form action="" method="post">
								<div class="search-product pos-relative of-hidden">
									<input class="s-text7 size6 p-l-23 p-r-50" type="text" name="pencarian" placeholder="Search Products..." value="">
					...
					<div class="row" id="fungsi_produk" name="fungsi_produk">
						...
						while ($dProduk = $produk->fetch_assoc()) {
							...
							?>
						<div class="col-6 col-md-6 col-lg-4 p-b-50 h-100">
							<!-- Block2 -->
							<div class="block2">
							<!-- block label new : block2-labelnew -->
								<div class="block2-img bo4 wrap-pic-w of-hidden pos-relative ">
									...
									<div class="block2-overlay trans-0-4">
										...
										<!-- <form method="post" action="" class="block2-btn-addcart"> -->
											<div class="block2-btn-addcart w-size1 trans-0-4">
												...
												<a href="product-detail?did=<?php echo $ecIdPro; ?>"><button name="" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4" value="<?php echo $dProduk['id_produk'];?>">
													Lanjutkan
												</button></a>
											</div>
										<!-- </form> -->
								...
								<div class="block2-txt p-t-20 h-100">
									...
									<span class="block2-price m-text6 p-r-5" name="tmbh_harga_produk">
										Rp <?php echo number_format($dProduk['harga']); ?>
									</span>
								</div>
								<footer class="block2-txt p-t-20 h-100">
					...
					<ul class="pagination flex-m flex-w p-t-26">
						...
						if ($total_no_of_pages <= 10) {  	 
							for ($counter = 1; $counter <= $total_no_of_pages; $counter++){
								if ($counter == $page_no) {
									echo "<li class=''><a class='item-pagination  flex-c-m trans-0-4' >$counter</a></li>";	
								}
								else {
					...
					<!-- Pagination -->
					<!-- <div class="pagination flex-m flex-w p-t-26">
						<a href="#" class="item-pagination flex-c-m trans-0-4 -pagination">1</a>
